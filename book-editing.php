      ...
      <div class="row justify-content-center text-center">
        <div class="col-xl-8 col-lg-9 col-md-11 col-12">
          <h1 class="f-55 clr-1 fw-700 mt-4">
            Professional
            <span class="d-block mt-3"><span class="bg-1 clr-l px-2">Book Editing Services</span></span>
            for Authors
          </h1>
          <p class="">
            Looking for high-quality book editing services? Our expert team of editors specializes in
            refining your manuscript and enhancing clarity, structure, and style. Whether you're a
            first-time author or a seasoned writer, we help you create a polished, ready-to-publish book.
            Let us transform your draft into a masterpiece with professional editing services tailored to
            your needs.
          </p>
        </div>
        <!--Contact form start-->
      ...
      <div class="row justify-content-between align-items-center">
        <div class="col-md-7 mt-4 mt-md-0 text-center text-md-start">
          <h3 class="f-40 clr-1 fw-700 mb-3">
            Comprehensive Editing Solutions for Every Genre
          </h3>
          <p>
            At <?php echo WEBSITE_NAME; ?>, we offer comprehensive editing solutions for authors of all genres. From
            developmental editing, which focuses on overall structure and content, to line editing and
            copyediting, we ensure your work flows seamlessly and reads perfectly. Our experienced editors
            are passionate about helping you tell your story, no matter the genre.
          <div class="row">
