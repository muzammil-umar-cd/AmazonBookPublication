        ...
        <div class="row justify-content-center text-center">
          <div class="col-xl-8 col-lg-9 col-md-11 col-12">
            <h1 class="f-55 clr-1 fw-700 mt-4">
              Expert
              <span class="d-block mt-3"><span class="bg-1 clr-l px-2">Fantasy Ghostwriting
                  Services</span></span>
              To Bring Your Imagination to Life
            </h1>
            <p class="">
              At <?php echo WEBSITE_NAME; ?>, we specialize in professional fantasy ghostwriting services that help
              you create captivating, immersive worlds and unforgettable characters. Whether you're a
              seasoned author or a first-time writer, our experienced ghostwriters bring your fantastical
              ideas to life while maintaining your unique voice.
            </p>
          </div>
          <!--Contact form start-->
        ...
        <div class="row justify-content-between align-items-center">
          <div class="col-md-7 mt-4 mt-md-0 text-center text-md-start">
            <h3 class="f-40 clr-1 fw-700 mb-3">
              Crafting Epic Fantasy Stories with Skill and Creativity
            </h3>
            <p>
              Our team of expert fantasy ghostwriters excels in creating original and engaging fantasy
              novels, short stories, and series. We work closely with you to develop intricate plots,
              magical systems, and rich world-building, ensuring your story resonates with fantasy fans
              and stands out in the competitive genre.
            </p>
            <div class="row">
