  ...
  <section class="banner lozad bg" data-background-image="assets/img/book-publishing-banner.webp">
    <div class="overlay py-5 position-relative">
      <img class="lozad sub-ban-left" alt="Audio Book servcies by <?php echo WEBSITE_NAME; ?>"
        data-src="assets/img/BW-before.webp"><img class="lozad sub-ban-right"
        alt="Audio Book servcies by <?php echo WEBSITE_NAME; ?>" data-src="assets/img/BW-after.webp">
      <div class="container-xl py-5 mt-5">
        <div class="row justify-content-center text-center">
          <div class="col-xl-8 col-lg-9 col-md-11 col-12">
            <h1 class="f-55 clr-1 fw-700 mt-4">
              Take Control of Your Literary Journey
              with
              <span class="d-block mt-3"><span class="bg-1 clr-l px-2">Expert Self-Publishing
                  Services</span></span>
            </h1>
            <p class="">
              Self-publishing offers authors the freedom to publish their work on their own terms, and at
              <?php echo WEBSITE_NAME; ?>, we’re here to guide you every step of the way. From manuscript preparation
              and formatting to cover design and distribution, our self-publishing services ensure your
              book is professionally produced and ready to reach a global audience. With our support,
              you’ll gain full control over your book’s release and marketing, while also accessing top
              platforms like Amazon Kindle Direct Publishing (KDP) and IngramSpark. Let us help you bring
              your vision to life and succeed in the competitive world of self-publishing.
            </p>
          </div>
          <!--Contact form start-->
        ...
        <div class="row justify-content-between align-items-center">
          <div class="col-md-7 mt-4 mt-md-0 text-center text-md-start">
            <h3 class="f-40 clr-1 fw-700 mb-3">
              The Benefits of Self-Publishing for Authors
            </h3>
            <p>
              Self-publishing offers numerous benefits, including creative control, faster publishing
              timelines, and higher royalty rates. Authors can decide on the pricing, marketing
              strategies, and distribution channels for their book. Additionally, the flexibility to
              update or revise the content post-publication is a significant advantage. With no middleman,
              self-published authors can also keep a larger percentage of the profits from their book
              sales.
            <div class="row">
